/**
 * @file SanitizeHWAddressHandler.hpp
 * @brief Handler that applies hardware address sanitizer attributes to LLVM functions.
 *
 * @responsibilities
 * - Part of the chain of function attribute handlers in the Lynx compiler.
 * - Intended to mark functions for hardware address sanitizer checks.
...
#ifndef LYNX_FUNC_SANITIZE_HW_ADDRESS_HANDLER_HPP
#define LYNX_FUNC_SANITIZE_HW_ADDRESS_HANDLER_HPP

#include "attributes/FunctionAttributeHandler.hpp"

namespace LynxFunctionAttr {

    class SanitizeHWAddressHandler : public FunctionAttributeHandler {
        protected:
            void apply(llvm::Function* func, FunctionAttributeBuilder& builder) override {
                ...
                for (const auto &BB : *func) {
                    for (const auto &I : BB) {
                        ...
                        // Detect memory intrinsics: memcpy, memset, memmove
