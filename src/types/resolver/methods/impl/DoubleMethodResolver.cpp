...
namespace LynxTypes {
    ...
    llvm::Value* DoubleMethodResolver::resolveInstanceMethod(
    ...
    llvm::Value* DoubleMethodResolver::resolveTypeMethod(
        const AstContext& /*ctx*/,
        const std::string& /*method*/, 
        const std::vector<llvm::Value*>& /*args*/
    ) noexcept { return nullptr; }
    llvm::Value* DoubleMethodResolver::convertToString(const AstContext& /*ctx*/, llvm::Value* /*instance*/) noexcept { return nullptr; }
    llvm::Value* DoubleMethodResolver::performClone(const AstContext& /*ctx*/, llvm::Value* /*instance*/) noexcept { return nullptr; }
    llvm::Value* DoubleMethodResolver::performTypeCast(const AstContext& /*ctx*/, llvm::Value* /*instance*/, llvm::Type* /*llvmType*/) noexcept { return nullptr; }
