...
namespace LynxTypes {
    ...
    llvm::Value* DoubleMethodResolver::convertToString(const AstContext& ctx, llvm::Value* instance) noexcept {
        LOG_ERROR("Invoked...................");
        return nullptr;
    }

    llvm::Value* DoubleMethodResolver::performClone(const AstContext& ctx, llvm::Value* instance) noexcept {
        LOG_ERROR("Invoked...................");
        return nullptr;
    }

    llvm::Value* DoubleMethodResolver::performTypeCast(const AstContext& ctx, llvm::Value* instance, llvm::Type* targetType) noexcept {
        LOG_ERROR("Invoked...................");
        return nullptr;
    }
