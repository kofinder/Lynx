...
namespace LynxTypes {
    ...
    llvm::Value* ShortMethodResolver::convertToString(const AstContext& ctx, llvm::Value* instance) noexcept {
        LOG_ERROR("Invoked...................");
        return nullptr;
    }

    llvm::Value* ShortMethodResolver::performClone(const AstContext& ctx, llvm::Value* instance) noexcept {
        LOG_ERROR("Invoked...................");
        return nullptr;
    }

    llvm::Value* ShortMethodResolver::performTypeCast(const AstContext& ctx, llvm::Value* instance, llvm::Type* targetType) noexcept {
        LOG_ERROR("Invoked...................");
        return nullptr;
    }
