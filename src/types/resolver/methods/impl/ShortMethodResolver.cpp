...
namespace LynxTypes {
    ...
    llvm::Value* ShortMethodResolver::resolveInstanceMethod(
    ...
    llvm::Value* ShortMethodResolver::resolveTypeMethod(
        const AstContext& /*ctx*/,
        const std::string& /*method*/, 
        const std::vector<llvm::Value*>& /*args*/
    ) noexcept { return nullptr; }
    llvm::Value* ShortMethodResolver::convertToString(const AstContext& /*ctx*/, llvm::Value* /*instance*/) noexcept { return nullptr; }
    llvm::Value* ShortMethodResolver::performClone(const AstContext& /*ctx*/, llvm::Value* /*instance*/) noexcept { return nullptr; }
    llvm::Value* ShortMethodResolver::performTypeCast(const AstContext& /*ctx*/, llvm::Value* /*instance*/, llvm::Type* /*llvmType*/) noexcept { return nullptr; }
