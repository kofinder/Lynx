...
namespace LynxTypes {
    ...
    llvm::Value* LongMethodResolver::convertToString(const AstContext& /*ctx*/, llvm::Value* /*instance*/) noexcept { return nullptr; }
    llvm::Value* LongMethodResolver::performClone(const AstContext& /*ctx*/, llvm::Value* /*instance*/) noexcept { return nullptr; }
    llvm::Value* LongMethodResolver::performTypeCast(const AstContext& /*ctx*/, llvm::Value* /*instance*/, llvm::Type* /*llvmType*/) noexcept { return nullptr; }
